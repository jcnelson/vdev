 ...
 * hashmap.h
 * 
 * Forked from systemd/src/shared/hashmap.h on March 26, 2015
 * 
...
#ifndef _LIBUDEV_COMPAT_HASHMAP_H_
#define _LIBUDEV_COMPAT_HASHMAP_H_
...
static inline int ordered_hashmap_move(OrderedHashmap * h,
...
int internal_hashmap_move_one(HashmapBase * h, HashmapBase * other,
			      const void *key);
static inline int hashmap_move_one(Hashmap * h, Hashmap * other,
				   const void *key)
{
...
static inline void *ordered_hashmap_iterate(OrderedHashmap * h, Iterator * i,
					    const void **key)
{
	return internal_hashmap_iterate(HASHMAP_BASE(h), i, key);
}
