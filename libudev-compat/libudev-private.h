 ...
 * libudev-private.c
 * 
 * Forked from systemd/src/libudev/libudev-private.c on March 26, 2015
 * 
...
#ifndef _LIBUDEV_COMPAT_PRIVATE_H_
#define _LIBUDEV_COMPAT_PRIVATE_H_
...
int udev_queue_export_device_queued(struct udev_queue_export *udev_queue_export,
				    struct udev_device *udev_device);
